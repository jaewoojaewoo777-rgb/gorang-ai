...
// 미심사 앱은 Direct Post(video.publish) 불가 → Inbox 업로드(video.upload)만 허용.
// 영상이 사용자 틱톡 앱 알림함/드래프트로 전송되고, 사용자가 앱에서 게시 완료.
...
// 6. 영상 업로드 (Inbox 업로드 · FILE_UPLOAD · 단일 청크)
//    미심사 앱은 Direct Post 불가 → Inbox(드래프트)로 전송. post_info 없음.
//    사용자가 틱톡 앱 알림함에서 게시를 마무리함.

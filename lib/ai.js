...
export async function generateCaption({ shopName, shopLocation, shopType, customPrompt, subLang = 'en', imageBase64List = [], tone = 'trendy' }) {
  ...
  const toneGuide = {
    ...
    jeju_uncle: `장년의 제주 삼촌이 옆에서 능청스럽게 말 거는 톤. 걸걸하고 유쾌하며 여유있게. 규칙:
- 어미: "~하지", "~거든", "~하는 거야", 가끔 "~마씸" 살짝만 (과하면 안 됨)
- 추임새: "어~", "근데 말이야", "이게 웃긴 게" 자연스럽게 삽입
- 정보를 "알려준다"가 아니라 "몰래 흘려준다" 느낌 — 잘난 척 없이 능청스럽게
- 첫 문장은 반드시 궁금증 유발 훅 (예: "여름 오면 이거 못 본다", "여기 아는 사람 별로 없지")
- 마지막 문장은 반드시 "자, 핀 하나 꽂았수다."로 끝낼 것
- 절대 금지: "여러분 안녕하세요", "오늘 소개해드릴 곳은", 뻔한 관광 카피 문구
- 해시태그는 #제주 #핀 관련으로`,
  }
